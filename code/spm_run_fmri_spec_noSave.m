function out = spm_run_fmri_spec_noSave(job)
%%%%DH%%%% This function was modified to retrieve the design matrix of the 
%%%%DH%%%% model without saving the outcome to SPM.mat.
%%%%DH%%%% Modified by: Daniel Huber, University of Innsbruck, 2024
...
%-Setting up the GLM
%==========================================================================
SPM = spm_fmri_spm_ui_noSave(SPM);
